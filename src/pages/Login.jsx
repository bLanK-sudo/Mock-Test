            ...
            <div class="card bg-base-300 m-4">
                ...
                <div class="card-body flex flex-col gap-4">
                    ...
                    <div class="card-actions justify-end">
                        <A class="link" href="/forgot_pwd">Forgot Password?</A>
                    </div>
                    <div class="card-actions justify-center">
                    <button type="submit" ref={loginBtn} class="btn btn-accent w-full" onClick={async() => {
                        console.log(document.getElementById("email").value,  document.getElementById("pwd").value);
                        try{
                            loginBtn.innerHTML = "<div class='loading loading-spinner loading-sm'></div> Logging In...";
                        ...
                        if(!response.ok) {
                            ...
                            if(data) setIsAuthenticated(true); localStorage.setItem("token", data.access); localStorage.setItem("authenticated", "true"); navigate("/home", {replace:true});
                            console.log(data);
                        }
                    ...
                    <div class="p-4">Don't have an account? <A href="/signup" class="link">Sign Up</A></div>
                    </div>
                </div>
            </div>
